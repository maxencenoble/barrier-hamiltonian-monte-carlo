classdef Sampler_GL < dynamicprops
    properties
        % Input
        ...
        total_samples = []      % list of all samples
        list_accept_ratio = [] % list of mean acceptance ratio
    ...
    methods
        function o = Sampler_GL(problem, opts)
            o.problem = problem;
            o.opts = opts;
            ...
            o.stepSizeAdap = opts.initalStepSize;
        ...
        function step(o)
            ...
            % set stepsize to the adaptive one
            o.stepSize = min(o.stepSizeAdap);
            
            % x step
            o.H1 = o.ham.H(o.x, o.v_);
            [o.x_, o.v_, o.ODEStep,reverseCheck] = o.opts.odeMethod(o.x, o.v_, o.stepSizeAdap, o.ham, o.opts);
            o.feasible = o.ham.feasible(o.x_, o.v_);
            o.H2 = o.ham.H(o.x_, -o.v_);
            o.prob = min(1, exp(o.H1-o.H2)) .* o.feasible;
            o.prob = o.prob.*reverseCheck;
            ...
            accept_ratio_mean = o.acceptedStep/(o.i + (o.i==0));

            if mod(o.i, o.opts.thin) == 0
                out_i = o.problem.T * o.x' + o.problem.y;
                o.total_samples = [o.total_samples out_i];
                o.list_accept_ratio = [o.list_accept_ratio, accept_ratio_mean];
            end
            
            if (mod(o.i, 10) == 0)
            	    o.stepSizeAdap = (accept_ratio_mean' > 0.3).*o.stepSizeAdap + (accept_ratio_mean' <= 0.3).*o.stepSizeAdap/1.1;
            	    o.stepSizeAdap = (accept_ratio_mean' > 0.9).*o.stepSizeAdap*1.1 + (accept_ratio_mean' <= 0.9).*o.stepSizeAdap;
            end
            
            stepSizeAdap_temp = o.stepSizeAdap + o.opts.gamma_0*(accept_ratio_mean'-0.5)/(1+o.i)^(o.opts.gamma_alpha);
            o.stepSizeAdap = max(stepSizeAdap_temp,o.opts.minStepSize);
        ...
        function finalize(o)
            ...
            o.output.total_samples = o.total_samples;
            o.output.list_accept_ratio = o.list_accept_ratio;
        end
