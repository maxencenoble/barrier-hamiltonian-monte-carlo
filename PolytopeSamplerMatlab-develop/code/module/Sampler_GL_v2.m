classdef Sampler_GL_v2 < dynamicprops
    properties
        % Input
    ...
    methods
        function o = Sampler_GL_v2(problem, opts)
            o.problem = problem;
            o.opts = opts;
        ...
        function step(o)
            ...
            [o.x_, o.v_, o.ODEStep,reverseCheck] = o.opts.odeMethod(o.x, o.v_, o.stepSize, o.ham, o.opts);
